...
HD_PWD='/home/vir/Lab5/Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hexcounterdisplay.vdi -applog -m64 -messageDb vivado.pb -mode batch -source hexcounterdisplay.tcl -notrace
