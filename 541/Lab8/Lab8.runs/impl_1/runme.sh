...
HD_PWD='/home/vir/Lab8/Lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vgadisplaydriver.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vgadisplaydriver.tcl -notrace
